...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium cursor-pointer transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "gradient-surface text-white",
        compass: "rounded-lg gradient-surface text-white",
        compassOutline: "rounded-lg border border-white/10 bg-white/[0.03] text-foreground backdrop-blur-md hover:bg-white/[0.06] hover:border-primary/40",
        destructive: "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "border border-white/10 bg-white/[0.03] text-foreground backdrop-blur-md hover:bg-white/[0.06] hover:border-primary/40",
