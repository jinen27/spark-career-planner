...
export function AppNav({ initials = "ST" }: { initials?: string }) {
  ...
  const links = [{ to: "/dashboard", label: "Dashboard" }, { to: "/reality-checker", label: "Reality Check" }, { to: "/explorer", label: "Explorer" }, { to: "/assessment", label: "Assessment" }, { to: "/profile", label: "Profile" }] as const;
