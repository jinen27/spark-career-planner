...
export function AppNav({ initials = "ST" }: { initials?: string }) {
  ...
  const links = [{ to: "/dashboard", label: "Dashboard" }, { to: "/roadmap", label: "Roadmap" }, { to: "/reality-checker", label: "Reality Check" }, { to: "/university-matcher", label: "Universities" }, { to: "/statement-coach", label: "Statement Coach" }, { to: "/explorer", label: "Explorer" }, { to: "/assessment", label: "Assessment" }, { to: "/feedback", label: "Feedback" }, { to: "/profile", label: "Profile" }] as const;
